  	...
  	function searchStep() {
  		...
  		var message = {"type":"STEP"};
  		 ...
  		 $.ajax({
				...
				timeout : 100000,
				success : function(data) {
					console.log("SEARCH STEP PRIM SUCCESSFUL");
					...
					if (data["status"] == "STEP" || data["status"] == "FINISHED") {
						...
						console.log(snapVertices.length + " " + snapAdjacencies.length);
...
Then the Prim algorithm is applied step-by-step with a redraw at every step. At each step all edges that belong to the tree are drawn in blue, the other edges are drawn in black.<br/>
...
The partial cost is displayed at each step.
  ...
  <div id="controls">
    <div id="Prim">
      <p>Click here to extract the largest connected component</p>
